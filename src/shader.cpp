...
{
    std::string vShaderCodeString = read_file(vertexPath);
    std::string fShaderCodeString = read_file(fragmentPath);
...
void Shader::setFloat(const std::string& name, const float value1) const
{
